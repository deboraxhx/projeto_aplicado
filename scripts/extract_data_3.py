...
caminho_pasta_pdf = 'dados/source/PDF3'
caminho_pasta_csv = 'dados/raw/raw3'
...
for nome_arquivo in os.listdir(caminho_pasta_pdf):
    if nome_arquivo.lower().endswith('.pdf'):
        ...
        tabela_completa.drop(
            tabela_completa.columns[[2, 3]], axis=1, inplace=True)
...
dados_completos.to_csv(
    'dados/merged/dados_completos_3.csv', index=False, sep=';')
